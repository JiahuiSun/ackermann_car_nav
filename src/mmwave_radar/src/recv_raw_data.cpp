...
char strRecordFilePath[] = "/home/dingrong/Code/ackermann_car_nav/data/frame_";
...
int main(int argc, char* argv[]) {
    ...
    ros::NodeHandle nh;
    // 创建话题订阅对象
    ros::Subscriber sub = nh.subscribe<mmwave_radar::adcData>("mmwave_radar_raw_data", 10, saveData);
